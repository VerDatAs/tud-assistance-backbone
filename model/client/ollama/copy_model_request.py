...
class CopyModelRequest(BaseModel):
    ...
    """  # noqa: E501
    source: StrictStr = Field(description="Name of the model to copy.")
    destination: StrictStr = Field(description="Name of the new model.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CopyModelRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CopyModelRequest from a dict"""
        if obj is None:
            return None
