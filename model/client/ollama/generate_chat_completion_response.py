...
class GenerateChatCompletionResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["message", "model", "created_at", "done", "total_duration", "load_duration",
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GenerateChatCompletionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GenerateChatCompletionResponse from a dict"""
        if obj is None:
            return None
