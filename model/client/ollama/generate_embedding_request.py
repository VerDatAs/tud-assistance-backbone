...
class GenerateEmbeddingRequest(BaseModel):
    ...
    prompt: StrictStr = Field(description="Text to generate embeddings for.")
    options: Optional[RequestOptions] = None
    __properties: ClassVar[List[str]] = ["model", "prompt", "options"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GenerateEmbeddingRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GenerateEmbeddingRequest from a dict"""
        if obj is None:
            return None
