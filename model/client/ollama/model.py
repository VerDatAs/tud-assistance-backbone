...
class Model(BaseModel):
    ...
    modified_at: Optional[datetime] = Field(default=None, description="Model modification date.")
    size: Optional[StrictInt] = Field(default=None, description="Size of the model on disk.")
    __properties: ClassVar[List[str]] = ["name", "modified_at", "size"]
