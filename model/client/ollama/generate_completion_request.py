...
class GenerateCompletionRequest(BaseModel):
    ...
    prompt: StrictStr = Field(description="The prompt to generate a response.")
    images: Optional[List[StrictStr]] = Field(default=None,
                                              description="(optional) a list of Base64-encoded images to include in the message (for multimodal ollama such as llava)")
    system: Optional[StrictStr] = Field(default=None,
                                        description="The system prompt to (overrides what is defined in the Modelfile).")
    template: Optional[StrictStr] = Field(default=None,
    ...
    raw: Optional[StrictBool] = Field(default=None,
    ...
    __properties: ClassVar[List[str]] = ["model", "prompt", "images", "system", "template", "context", "options",
                                         "format", "raw", "stream", "keep_alive"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GenerateCompletionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GenerateCompletionRequest from a dict"""
        if obj is None:
            return None
