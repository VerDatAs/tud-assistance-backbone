...
class AssistancePhaseStep(BaseModel):
    """
    A step of a phase during which assistance is provided.
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["operationKey", "duration", "parameters"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AssistancePhaseStep from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AssistancePhaseStep from a dict"""
        if obj is None:
            return None
