...
class Setting(BaseModel):
    """
    Schema for representing a setting of the system.
    """  # noqa: E501
    key: StrictStr = Field(description="The unique key of the setting.")
    value: Optional[Any] = Field(default=None, description="The value of the setting.")
