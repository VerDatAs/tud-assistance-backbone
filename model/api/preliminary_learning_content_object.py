...
class PreliminaryLearningContentObject(BaseModel):
    """
    Schema for representing a generic Learning Content Object (LCO) to be created.
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["lcoType", "objectId", "attributes"]
    ...
    def __init__(__pydantic_self__, **data: Any) -> None:
        ...
        for i, attribute in enumerate(__pydantic_self__.attributes):
            if type(attribute.value) is dict:
                __pydantic_self__.attributes[i].value = PreliminaryLearningContentObject.model_validate(attribute.value)
            elif type(attribute.value) is list:
                __pydantic_self__.attributes[i].value = list(
                    map(lambda sub_preliminary_lco: PreliminaryLearningContentObject.model_validate(
                        sub_preliminary_lco),
                        attribute.value))
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PreliminaryLearningContentObject from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PreliminaryLearningContentObject from a dict"""
        if obj is None:
            return None
