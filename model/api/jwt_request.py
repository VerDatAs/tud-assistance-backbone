...
class JwtRequest(BaseModel):
    """
    Schema for representing credentials required for JWT creation.
    """  # noqa: E501
    actor_account_name: StrictStr = Field(description="The account name of the user.", alias="actorAccountName")
    password: Optional[StrictStr] = Field(default=None, description="The password of the user.")
    __properties: ClassVar[List[str]] = ["actorAccountName", "password"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "actorAccountName": obj.get("actorAccountName"),
