...
class StudentModelList(BaseModel):
    """
    Schema for representing a container object that encapsulates Student Models.
    """  # noqa: E501
    students: List[StudentModel] = Field(description="The encapsulated Student Models.")
    total_number: Annotated[int, Field(strict=True, ge=0)] = Field(
        description="The total number of Student Models encapsulated.", alias="totalNumber")
    provided_number: Annotated[int, Field(strict=True, ge=0)] = Field(
        description="The provided number of Student Models.", alias="providedNumber")
    page_number: Annotated[int, Field(strict=True, ge=1)] = Field(description="The provided page.", alias="pageNumber")
    __properties: ClassVar[List[str]] = ["students", "totalNumber", "providedNumber", "pageNumber"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StudentModelList from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StudentModelList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "students": [StudentModel.from_dict(_item) for _item in obj.get("students")] if obj.get(
                "students") is not None else None,
