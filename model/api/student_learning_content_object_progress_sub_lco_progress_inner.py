...
class StudentLearningContentObjectProgressSubLcoProgressInner(BaseModel):
    """
    StudentLearningContentObjectProgressSubLcoProgressInner
    """  # noqa: E501
    key: StrictStr = Field(description="The identified of the LCO that was experienced.")
    value: Optional[List[Experience]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StudentLearningContentObjectProgressSubLcoProgressInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StudentLearningContentObjectProgressSubLcoProgressInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "value": [Experience.from_dict(_item) for _item in obj.get("value")] if obj.get(
