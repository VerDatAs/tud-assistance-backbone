...
class AssistanceInitiationRequestParameterConditionRequiredValuesInner(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    AssistanceInitiationRequestParameterConditionRequiredValuesInner - a model defined in OpenAPI

    """


AssistanceInitiationRequestParameterConditionRequiredValuesInner.update_forward_refs()
