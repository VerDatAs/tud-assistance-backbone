...
class AssistanceTypeList(BaseModel):
    """
    Schema for representing a container object that encapsulates Assistance Types.
    """  # noqa: E501
    types: List[AssistanceType] = Field(description="The encapsulated Assistance Types.")
    total_number: Annotated[int, Field(strict=True, ge=0)] = Field(
        description="The total number of Assistance Types encapsulated.", alias="totalNumber")
    provided_number: Annotated[int, Field(strict=True, ge=0)] = Field(
        description="The provided number of Assistance Types.", alias="providedNumber")
    page_number: Annotated[int, Field(strict=True, ge=1)] = Field(description="The provided page.", alias="pageNumber")
    __properties: ClassVar[List[str]] = ["types", "totalNumber", "providedNumber", "pageNumber"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AssistanceTypeList from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AssistanceTypeList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "types": [AssistanceType.from_dict(_item) for _item in obj.get("types")] if obj.get(
                "types") is not None else None,
