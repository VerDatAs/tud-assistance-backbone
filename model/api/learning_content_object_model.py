...
from model.api.learning_content_object_attribute_model import LearningContentObjectAttributeModel
...
class LearningContentObjectModel(BaseModel):
    """
    Schema for representing a metamodel that describes a type of Learning Content Object.
    """  # noqa: E501
    lco_type: StrictStr = Field(description="The unique identifier of the type of the LCO.", alias="lcoType")
    attributes: Optional[List[LearningContentObjectAttributeModel]] = Field(default=None,
                                                                            description="A list of attribute definitions of the LCO.")
    __properties: ClassVar[List[str]] = ["lcoType", "attributes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LearningContentObjectModel from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LearningContentObjectModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "attributes": [LearningContentObjectAttributeModel.from_dict(_item) for _item in
